...
win_strength = random.randint(1,5)
win_intellect = random.randint(1,5)
...
GAME_SENTENCE3 = "Your goal will be to eliminate and recruit survivors to achieve a level of " + str(win_strength) + " for strength and " + str(win_intellect) + " for intellect."
